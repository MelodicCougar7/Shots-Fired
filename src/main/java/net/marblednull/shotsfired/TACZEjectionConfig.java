...
//remember that trailing commas are not permitted in this class
...
public class TACZEjectionConfig {
    ...
    "tacz:glock_17", new EjectionInfo(0.25, true, 85.0, 1.0, -0.25, 0.15),
    "tacz:hk_mp5a5", new EjectionInfo(0.25, true, 85.0, 1.0, -0.25, 0.15)
