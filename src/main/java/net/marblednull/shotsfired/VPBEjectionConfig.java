...
public class VPBEjectionConfig {
    public static final Config EJECTION_CONFIG =  new Config("shotsfired-vpb-ejection-config");
    ...
    public static final ConfigValue<LinkedHashMap<String, EjectionInfo>> EJECTION_MAP = new ConfigValue<>(new LinkedHashMap<>(Map.of(
            ...
            "pointblank:glock17", new EjectionInfo(1.0, true, 85.0, 1.0, -0.25, 0.15),
            "pointblank:hk_mp5a5", new EjectionInfo(1.0, true, 85.0, 1.0, -0.25, 0.15)

    )), "Ejected Casing Data by Gun's ItemId.", EJECTION_CONFIG);
